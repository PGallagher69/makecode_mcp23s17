...
namespace mcp23s17 {
    ...
    export class MCPDevice {
         ...
         * 
        */
        //% blockId=initialise_mcp block="Initialise MCP23S17 Device"
         ...
         * Read a GPIO Pin
         */
        //% blockId=read_gpio_pin block="Read GPIO %pinno of MCP Device"
         ...
         * 
        */
        //% blockId=read_gpio block="Read GPIO Pins of Bank %bank of MCP Device"
